        ...
        updates=[
            python_planning.PythonPlanningStep(
                ...
                code=(
                    ...
                    "print(f'Tuebingen: {population1}, Zuerich: {population2}')"
                ),
                result=(
                    "Tuebingen: [{'index': 1, 'Name': 'Tübingen', 'County':"
                    " 'Tübingen', 'Population Estimate 2021-12-31': '91,877'},"
                    " {'index': 2, 'Name': 'Tübingen 91,877 Population [2021] –"
                    ' Estimate 108.1 km2 Area 850.2/km2 Population Density'
                    " [2021] 1.0% Annual Population Change [2011 → 2021]',"
                    " 'County': '', 'Population Estimate 2021-12-31': ''}],"
